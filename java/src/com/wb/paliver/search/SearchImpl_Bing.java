...
public class SearchImpl_Bing implements SearchInterface {

	public static final String searchType = "Bing";
	
	// URL parts that make up the full search url
	private String urlBase = "https://www.bing.com";
	private String urlSearchSuffix = "/search?";
	
	// the regex pattern to search for in the HTML results string
	private String pageCountPattern = "class=\"sb_count\".*>([0-9,]*?) results";
	...
	public String getPage(String query) throws IOException {
		...
		// NOTE: the plus sign is used to do exact matcing
		urlFull += "q=%2B" + URLEncoder.encode(query, "UTF-8");
