...
public class SearchApi {
	 ...
	 * 
	 * @param searchType
	 *            - a string representing the desired backing search engine
	 *            (e.g. Google, Bing, Twitter, etc.)
	 */
	...
	/**
	 * Retrieves the HTML page from the current search engine.
	 * 
	 * @param query
	 *            - the word/phrase used for the query
	 */
	...
	/**
	 * Retrieves the page count (query result count) from the current search
	 * engine.
	 * 
	 * @param query
	 *            - the word/phrase used for the query
